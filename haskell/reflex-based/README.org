...
cd /Users/carr/.sync/.esync/openhc/rdf-triple-browser/haskell
~/try-reflex/work-on ghcjs reflex-based
cabal configure --ghcjs
cabal build

but can't find *.js file
and now ./try-reflex ... ghcjs --make RTB.hs   does not work
  - maybe because of module RTB declaration (maybe must be Main)
